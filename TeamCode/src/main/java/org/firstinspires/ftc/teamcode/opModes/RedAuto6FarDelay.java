...
@Autonomous(name = "Red Auto: Far 6 Ball Delay", preselectTeleOp = "TeleOpProvincialsRed")
public class RedAuto6FarDelay extends NextFTCOpMode {
    private Paths paths;
    private boolean aborted = false;

    public RedAuto6FarDelay() {
        addComponents(
