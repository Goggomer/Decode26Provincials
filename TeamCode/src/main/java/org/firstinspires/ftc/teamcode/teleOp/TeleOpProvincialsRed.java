...
public class TeleOpProvincialsRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Target X (Raw)", "%.2f°", RobotHardwareProvincialsRed.teleRawError) ;
            telemetry.addData("Target X (Filtered)", "%.2f°", RobotHardwareProvincialsRed.filteredError);
            telemetry.update();
        }
